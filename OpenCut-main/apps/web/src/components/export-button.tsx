...
export function ExportButton() {
  ...
  return (
    <>
      <button
        type="button"
        className="flex items-center gap-1.5 bg-primary text-white rounded-md px-[0.12rem] py-[0.12rem] cursor-pointer hover:brightness-95 transition-all duration-200"
      ...
      >
        <div className="flex items-center gap-1.5 bg-linear-270 from-primary to-primary rounded-[0.8rem] px-4 py-1 relative shadow-[0_1px_3px_0px_rgba(0,0,0,0.65)]">
          ...
          <div className="absolute w-full h-full left-0 top-0 bg-linear-to-t from-white/0 to-white/50 z-10 rounded-[0.8rem] flex items-center justify-center">
            <div className="absolute w-[calc(100%-2px)] h-[calc(100%-2px)] top-[0.08rem] bg-linear-270 from-primary to-primary z-50 rounded-[0.8rem]"></div>
          </div>
        </div>
      </button>
      <ExportDialog
